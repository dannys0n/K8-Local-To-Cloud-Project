...
<body>
  ...
  <main><div id="map"><svg id="infraEdges"></svg><div id="spareRow" class="infra-row top"></div><div id="proxyRow" class="infra-row bottom"></div><div id="infraStatus" hidden></div></div><aside>
    ...
    <div class="card"><label class="toggle"><input id="showAllServers" type="checkbox">Show all active servers</label><label class="toggle"><input id="showProxies" type="checkbox">Show proxies</label><label class="toggle"><input id="showHotSwaps" type="checkbox">Show reserve capacity</label></div>
