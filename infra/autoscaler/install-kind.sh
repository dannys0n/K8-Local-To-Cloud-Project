...
kubectl apply -k "$ROOT/infra/observability"
...
kubectl rollout status deployment/kube-state-metrics -n kube-system --timeout=180s
kubectl rollout status deployment/grafana -n tcp-lab --timeout=180s
